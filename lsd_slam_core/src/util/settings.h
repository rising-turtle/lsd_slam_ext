...
#define MAX_DIFF_CONSTANT (30.0f*30.0f) // 5.0
#define MAX_DIFF_GRAD_MULT (0.5f*0.5f)

extern double g_max_diff_constant; 
extern double g_max_diff_grad_mult; 
extern double g_min_goodperbad_pixel;

// #define MIN_GOODPERGOODBAD_PIXEL (0.5f) 
#define MIN_GOODPERGOODBAD_PIXEL (0.35f) // 0.25
#define MIN_GOODPERALL_PIXEL (0.04f)
#define MIN_GOODPERALL_PIXEL_ABSMIN (0.01f)

// #define INITIALIZATION_PHASE_COUNT 5
#define INITIALIZATION_PHASE_COUNT 3
...
extern bool pauseForTracking; 
extern bool saveGraphStructure;
class RunningStats
{
public:
