#ifndef DEPTH_MAP_SE3_H
#define DEPTH_MAP_SE3_H
...
/**
 * Keeps a detailed depth map (consisting of DepthMapSE3PixelHypothesis) and does
...
public:
	...
	DepthMapSE3(int w, int h, const Eigen::Matrix3f& K);
	DepthMapSE3(const DepthMapSE3&) = delete;
	DepthMapSE3& operator=(const DepthMapSE3&) = delete;
	~DepthMapSE3();
